...
export const generatePDF = async (data: OfferLetterData) => {
  ...
  const terms = 'This offer is contingent upon the successful completion of background checks and your ability to provide documentation proving your eligibility to work in the country.';
