    ...
    <div className="p-8 space-y-6 bg-white text-black">
      ...
      <div className="space-y-4">
        ...
        <p>
          ...
          {data.companyName}, located in {data.location}. We believe your skills
          and experience are an excellent match for our company.
        </p>
        ...
        <p>
          This offer is contingent upon the successful completion of background
          checks and your ability to provide documentation proving your eligibility
          to work in the country.
        </p>

        <p>
          We are excited about the prospect of you joining our team and believe you
          will be a great addition to {data.companyName}.
        </p>

        <p>
          Please confirm your acceptance of this offer by signing below and
          returning a copy of this letter by {format(new Date(new Date().setDate(new Date().getDate() + 7)), 'MMMM dd, yyyy')}.
        </p>
